...
if habitability_check == "Within the Goldilocks Zone" and equilibrium_temperature > 0 and equilibrium_temperature < 50:
...
# Analyzing the atmosphere of the planet for potential habitability


def analyze_atmosphere():
    if habitability_check == "Within the Goldilocks Zone" and (equilibrium_temperature <= 0 or equilibrium_temperature >= 50):
